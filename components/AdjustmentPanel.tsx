...
const AdjustmentPanel: React.FC<AdjustmentPanelProps> = ({ onApplyAdjustment, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Expand 16:9', prompt: 'Expand the image to a 16:9 aspect ratio by generating new, photorealistic content around the edges. The added content should seamlessly blend with the original image in style, lighting, and subject matter.' },
    { name: 'Expand 4:3', prompt: 'Expand the image to a 4:3 aspect ratio by generating new, photorealistic content around the edges. The added content should seamlessly blend with the original image in style, lighting, and subject matter.' },
  ];
