...
const CreativePanel: React.FC<CreativePanelProps> = ({ onApplyStyle, isLoading }) => {
  ...
  const presets = [
    ...
    { name: 'Vectorize', prompt: 'Recreate this image in a clean, minimalist vector art style with flat colors and bold outlines. The result should be a high-resolution raster image that looks like a vector graphic.' },
  ];
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      <h3 className="text-lg font-semibold text-center text-gray-300">Apply a Creative Style</h3>
      ...
      <input
        ...
        placeholder="Or describe a custom style (e.g., 'Van Gogh painting')"
